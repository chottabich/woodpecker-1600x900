...
class HandlerClass:
    def __init__(self, halcomp, widgets, paths):
        ...
        self.auto_list = ["chk_eoffsets", "cmb_gcode_history", "btn_pause_spindle", "btn_file", "btn_offsets", "btn_tool", "btn_probe", "btn_camera", "btn_utils", "btn_touchy"]
        self.axis_a_list = ["lbl_jog_angular", "dro_axis_a", "action_zero_a", "axistoolbutton_a",
...
""" %(os.path.join(paths.IMAGEDIR,'lcnc_swoop.png'))
    ...
    def initialized__(self):
        ...
        self.w.chk_eoffsets_checked(self.w.chk_eoffsets.isChecked())
        ...
        self.w.chk_use_mpg.stateChanged.connect(lambda state: self.chk_use_mpg_changed(state))
...
#                    QtCore.Qt.Key_F3,QtCore.Qt.Key_F4,QtCore.Qt.Key_F5):
    ...
    def main_tab_changed(self, btn):        
        ...
        self.w.stackedWidget_4.setCurrentIndex(self.tab_index_code[index])                
        if index == TAB_MAIN:
